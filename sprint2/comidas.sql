...
CREATE TABLE `carrito` (
  `id.carrito` int unsigned NOT NULL AUTO_INCREMENT,
  `id.cliente` int NOT NULL,
  `id.producto` int NOT NULL,
  `cantidad` int NOT NULL,
  PRIMARY KEY (`id.carrito`)
...
CREATE TABLE `cat_productos` (
  `id.cat.producto` int unsigned NOT NULL AUTO_INCREMENT,
  `categoria` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id.cat.producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clientes` (
  `id.clientes` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `direcciones` (
  `id.direccion` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `empleados` (
  `id.empleado` int unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `apellido` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `nif` int NOT NULL,
  `telefono` int NOT NULL,
  `id.puesto` tinyint(1) NOT NULL,
...
CREATE TABLE `pedidos` (
  `id.pedido` int unsigned NOT NULL AUTO_INCREMENT,
  `id.cliente` int NOT NULL,
  `fecha_hora` datetime NOT NULL,
  `envio` tinyint(1) NOT NULL,
  `id.direccion` int DEFAULT NULL,
  `id.tienda` int NOT NULL,
  `id.empleado` int NOT NULL,
  `hora_entrega` int DEFAULT NULL,
...
CREATE TABLE `productos` (
  `id.producto` int unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `descripcion` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `imagen` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `id.cat.productos` int NOT NULL,
  `precio` int NOT NULL,
...
CREATE TABLE `puestos` (
  `id.puesto` int unsigned NOT NULL AUTO_INCREMENT,
  `puesto` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id.puesto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tiendas` (
  `id.tienda` int unsigned NOT NULL,
  `nombre` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id.tienda`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-10-23 19:43:34
